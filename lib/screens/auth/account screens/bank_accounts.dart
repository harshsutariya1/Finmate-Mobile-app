            ...
            children: bankAccounts.map((bankAccount) {
              ...
              return Container(
                ...
                decoration: BoxDecoration(
                  ...
                  color: crouselIndex == index ? color3 : color2.withAlpha(100),
                ),
              );
            }).toList(),
          ),
            ...
            children: [
              Wrap(
                ...
                children: [
                  ...
                  Text(
                    selectedBankAccount?.bankAccountName ?? "Bank Account",
                    style: TextStyle(
                      fontSize: 18,
                      color: color2,
                    ),
                      ...
                      onTap: () async {
                        showYesNoDialog(context,
                          ...
                          if (await ref
                              ...
                              .deleteBankAccount(userData.uid!,
                                  selectedBankAccount?.bid ?? '', ref)) {
                            snackbarToast(
                                context: context,
